...
Features.prototype = {
  ...
  create: function() {
      ...
      this.icon1 = new Coin(this.game, 0, 260, 535);
      ...
      // Out Icons
      /*iconTween0.onComplete.addOnce(function(){
        iconTween0.to( { x: 0, y: 0 }, 380, Phaser.Easing.Back.In, true, 1200);
      }, this);
      iconTween1.onComplete.addOnce(function(){
        iconTween1.to( { x: 0, y: 0 }, 380, Phaser.Easing.Back.In, true, 1200);
      }, this);
      iconTween2.onComplete.addOnce(function(){
        iconTween2.to( { x: 0, y: 0 }, 380, Phaser.Easing.Back.In, true, 1200);
      }, this);
      iconTween3.onComplete.addOnce(function(){
        iconTween3.to( { x: 0, y: 0 }, 380, Phaser.Easing.Back.In, true, 1200);
      }, this);
      cajetillaTween.onComplete.addOnce(function(){
        cajetillaTween.to( { alpha: 0 }, 620, Phaser.Easing.Quartic.Out, true);
      }, this);*/
      ...
      this.delay = Phaser.Timer.SECOND * 5;
